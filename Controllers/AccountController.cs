...
using Issue_Tracker_Web_API.Results;
using Issue_Tracker_Web_API.Providers;
using System.Web.Http.Cors;
using Issue_Tracker_Web_API.Models;
using System.Data.Entity;
using Issue_Tracker_Web_API.Controllers;
using Issue_Tracker_Web_API.Models.DTOs;

namespace IssueTracker_web_api.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private void ConfigMapper()
        {
            ...
            {
                c.AddProfile<App_Start.MapperProfile>();
            });
        ...
        public IHttpActionResult DeleteUser(string id)
        {
            ...
            foreach(ApplicationUser ap in UserManager.Users)
            {
                if (ap.Id.Equals(id))
                {
                    au = ap;
            ...
            if (au == null)
            {
                return BadRequest("No se encontro ningun usuario con ese Id");
            }
            ...
            {
                return BadRequest("Error al borrar, revisa que no exista una relacion con otra tabla, si es asi anula la otra tabla antes y luego borra al usuario");
            }
        ...
        public UserDTO UpdateUser(string Id, UserUpdateDTO User)
        {
            ...
            ua.Apellido = User.Apellido;
            UserManager.Update(ua);
            return _Mapper.Map<UserDTO>(ua);
        }
